    ...
    <div className="flex-1 text-text-main">
      ...
      <div className="flex flex-wrap gap-4 mb-12">
        <button 
          ...
          className="flex items-center gap-3 px-6 py-4 bg-brand-primary text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-xl shadow-brand-primary/30"
        >
        ...
        <button 
          ...
          className="flex items-center gap-3 px-6 py-4 bg-white border-2 border-brand-muted/30 text-text-main rounded-2xl font-bold hover:border-brand-primary hover:text-brand-primary transition-all shadow-sm"
        >
          {isAdded ? (
            <>
